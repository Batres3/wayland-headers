...
LIBDECOR_REV=59c498aff477a3c23dcb5bfaa101c5d3287da629
WAYLAND_REV=e647f6304d7491fa436047908dc559f5badf613e
WAYLAND_PROTOCOLS_REV=8eeadc857ff40919465964b354c374113da99ba2
...
generate_glfw() {
    ...
    "$WAYLAND_SCANNER" client-header "$xml" "wayland-protocols/$out_name-client-protocol.h"
    "$WAYLAND_SCANNER" private-code "$xml" "wayland-protocols/$out_name-client-protocol-code.h"
}
